  ...
  const handleRequests = async (event) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8080/requests/insertRequest",
        {
          method: "POST",
          headers: {
        ...
        <div className="request-con">
          <div className="request-rem">
            ...
            <p className="request-para">
              The requesting of documents has a fee of P30.00 peso for each
              documents. And for others, additional P5.00 will be charge.
            </p>
          </div>
          <div>
                      ...
                      {usser.id !== null && usser.id === request.user.id ? (
                        ...
                        >
                          ...
                          <h3 style={{ color: "red", fontStyle: "italic" }}>
                            Document Request: {request.doctype}
                          </h3>
                          <h3 style={{ color: "blue", fontStyle: "italic" }}>
                            Document Status: {request.track}
                          </h3>
                        </Paper>
                      ) : (
                        <></>
          ...
          <div style={{ marginBottom: "50px" }}>
            <Grid container>
              <Grid item className="text-fields-container">
                <p className="name2">
                  Fill all the necessary informations and make sure to fill NA
                  for none
                </p>
                        ...
                        <div>
                          <div>
                            ...
                            >
                              ...
                              <option value="Male" style={{ fontSize: "20px" }}>
                                Male
                              </option>
                              <option
                                value="Female"
                  ...
                  <div>
                    <div>
                      ...
                      >
                        ...
                        <option value="Mangga" style={{ fontSize: "20px" }}>
                          Mangga
                        </option>
                        <option value="Upper" style={{ fontSize: "20px" }}>
                          Upper
                        </option>
                        <option value="Lower" style={{ fontSize: "20px" }}>
                          Lower
                        </option>
                        <option value="Crossing" style={{ fontSize: "20px" }}>
                          Crossing
                        </option>
                        <option value="Buenavista" style={{ fontSize: "20px" }}>
                          Buenavista
                        </option>
                        <option
                          value="Anami Homes"
                  ...
                  <Grid item>
                    <div>
                      ...
                      >
                        ...
                        <option value="A4" style={{ fontSize: "20px" }}>
                          A4
                        </option>
                        <option value="short" style={{ fontSize: "20px" }}>
                          short
                        </option>
                        <option value="long" style={{ fontSize: "20px" }}>
                          long
                        </option>
                      </select>
                    </div>
                ...
                <Grid item>
                  ...
                  <Modal open={showPopup} onClose={handleClosePopup}>
                    <div className="popup2">
                      ...
                      <p>
                        The payment will be processed onsite as well as the
                        releasing of the requested documents. An email will be
                        sent for the release schedule so make sure you enter an
                        active email or you can track your documents in the
                        system. Kindly bring a valid ID for identification
                        verification.
                        <br></br>
                        <br></br>
