...
export default function BLAdmin() {
  ...
  useEffect(() => {
    //whenever theres an updated or added business it will be stored in the localStorage so that everytime you refresh the page, the announcement will remain
  ...
  const onUpdateBusiness = (updatedBusiness) => {
    //send onUpdateBusiness from the main with an updated object
  ...
  const getActiveBusiness = () => {
    //get the current stored id and find it in the array and return the entire current object
