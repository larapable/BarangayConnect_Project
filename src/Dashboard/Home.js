          ...
          <Grid className="container2">
            <Grid item>
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                <Grid className="profilecontainer1" data-motto="An apple a day makes my heart kilig everyday">
                  <img
                    src="lara.jpg"
                    alt="Lara C. Pable"
                    style={{
                ...
                <Grid className="profilecontainer2" data-motto="I call him sugarplum">
                  <img
                    src="arziel.png"
                    alt="Lara C. Pable"
                    style={{
                ...
                <Grid className="profilecontainer3" data-motto="Cry and cry until you succeed">
                  <img
                    src="ebeb.jpg"
                    alt="Lara C. Pable"
                    style={{
                ...
                <Grid className="profilecontainer4" data-motto="Si kam3l lang ang akeng mahal">
                  <img
                    src="arvin.png"
                    alt="Lara C. Pable"
                    style={{
